...
{
	if (region.bc.ay === region.bv.ay)
	{
		return 'on line ' + region.bc.ay;
	}
	return 'on lines ' + region.bc.ay + ' through ' + region.bv.ay;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.ct, request.s, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {by: fragment, bB: host, bJ: path, bL: port_, bO: protocol, bP: query};
	});
...
var $author$project$Main$Model = F4(
	function (url, key, shared, page) {
		return {y: key, cA: page, A: shared, s: url};
	});
	...
	function (route, params, url, key) {
		return {
			...
			bP: A2(
				$elm$core$Maybe$withDefault,
				$elm$core$Dict$empty,
				A2($elm$core$Maybe$map, $ryannhg$elm_spa$ElmSpa$Request$query, url.bP)),
			cF: route,
			s: url
		};
	});
var $author$project$Gen$Route$NotFound = 1;
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {O: frag, R: params, L: unvisited, B: value, W: visited};
	});
...
var $author$project$Gen$Route$Home_ = 0;
...
var $author$project$Gen$Route$routes = _List_fromArray(
	[
		A2($elm$url$Url$Parser$map, 0, $author$project$Gen$Params$Home_$parser),
		A2($elm$url$Url$Parser$map, 1, $author$project$Gen$Params$NotFound$parser)
	]);
...
var $author$project$Gen$Msg$Home_ = $elm$core$Basics$identity;
...
var $ryannhg$elm_spa$ElmSpa$Page$toResult = F3(
	function (toPage, shared, req) {
		...
		return A2(
			toResult_,
			shared,
			A4($ryannhg$elm_spa$ElmSpa$Request$create, req.cF, 0, req.s, req.y));
	});
var $ryannhg$elm_spa$ElmSpa$Page$bundle = function (_v0) {
	var redirecting = _v0.cD;
	var toRoute = _v0.cO;
	var toUrl = _v0.cP;
	var fromCmd = _v0.cm;
	var mapEffect = _v0.cr;
	var mapView = _v0.cs;
	var page = _v0.cA;
	var toModel = _v0.cM;
	var toMsg = _v0.cN;
...
var $author$project$Gen$Pages$bundle = F3(
	function (page, toModel, toMsg) {
		return $ryannhg$elm_spa$ElmSpa$Page$bundle(
			{
				cm: $author$project$Effect$fromCmd,
				cr: $author$project$Effect$map(toMsg),
				cs: $author$project$View$map(toMsg),
				cA: page,
				cD: {cv: $author$project$Gen$Model$Redirecting_, a0: $author$project$View$none},
				cM: toModel,
				cN: toMsg,
				cO: $author$project$Gen$Route$fromUrl,
				cP: $author$project$Gen$Route$toHref
			});
	});
...
var $ryannhg$elm_spa$ElmSpa$Page$adapters = {
	aJ: function (page) {
		return {
			a4: $elm$core$Basics$always(page.a4),
			be: page.be,
			b2: page.b2,
			a0: page.a0
		};
	...
	cj: F2(
		function (fromCmd, page) {
			return {
				a4: function (_v0) {
					return A2($elm$core$Tuple$mapSecond, fromCmd, page.a4);
				},
				be: page.be,
				b2: F2(
					function (msg, model) {
	...
	aX: F2(
		function (none, page) {
			return {
				a4: function (_v1) {
					return _Utils_Tuple2(page.a4, none);
				},
				be: function (_v2) {
					return $elm$core$Platform$Sub$none;
				},
	...
	return F2(
		function (_v0, _v1) {
			return $elm$core$Result$Ok(
				$ryannhg$elm_spa$ElmSpa$Page$adapters.aJ(page));
		});
};
...
var $author$project$Pages$Home_$GotSearchResults = function (a) {
	return {$: 2, a: a};
};
var $author$project$Pages$Home_$Item = F3(
	function (title, url, imageUrl) {
		return {bC: imageUrl, bg: title, s: url};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{b9: false, cd: r.cd, ck: r.ck, bz: r.bz, ct: r.ct, cL: r.cL, b$: r.b$, s: r.s}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{cd: $elm$http$Http$emptyBody, ck: r.ck, bz: _List_Nil, ct: 'GET', cL: $elm$core$Maybe$Nothing, b$: $elm$core$Maybe$Nothing, s: r.s});
};
var $elm$json$Json$Decode$list = _Json_decodeList;
var $elm$json$Json$Decode$map3 = _Json_map3;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Pages$Home_$getSearchResult = function (query) {
	var decoder = A4(
		$elm$json$Json$Decode$map3,
		$author$project$Pages$Home_$Item,
			...
			case 1:
				return _Utils_Tuple2(
					...
					$author$project$Effect$fromCmd(
						$author$project$Pages$Home_$getSearchResult(model.aC)));
			default:
				var results = msg.a;
				if (!results.$) {
					var items = results.a;
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.cf) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.cw, record.cf, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	...
	var declarations = _v0.cg;
	return {
		bs: charset,
		cg: $rtfeldman$elm_css$Css$Structure$compactDeclarations(declarations),
		bD: imports,
		bH: namespaces
	};
};
...
var $robinheghan$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {Z: charsProcessed, ae: hash, T: seed, aj: shift};
	});
...
var $robinheghan$murmur3$Murmur3$finalize = function (data) {
	var acc = (!(!data.ae)) ? (data.T ^ A2(
		...
		A2(
			...
			15,
			A2($robinheghan$murmur3$Murmur3$multiplyBy, $robinheghan$murmur3$Murmur3$c1, data.ae)))) : data.T;
	var h0 = acc ^ data.Z;
...
var $robinheghan$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		var res = data.ae | ((255 & $elm$core$Char$toCode(c)) << data.aj);
		var _v0 = data.aj;
		if (_v0 === 24) {
			return {
				Z: data.Z + 1,
			...
			return {Z: data.Z + 1, ae: res, T: data.T, aj: data.aj + 8};
		}
	});
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bs: charset, cg: declarations, bD: imports, bH: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bs: $elm$core$Maybe$Nothing, bD: _List_Nil, bH: _List_Nil, bX: snippets};
};
...
var $author$project$UI$layout = function (body) {
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$max_w_3xl = A2($rtfeldman$elm_css$Css$property, 'max-width', '48rem');
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$mb_4 = A2($rtfeldman$elm_css$Css$property, 'margin-bottom', '1rem');
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pb_8 = A2($rtfeldman$elm_css$Css$property, 'padding-bottom', '2rem');
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$py_12 = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, 'padding-top', '3rem'),
			A2($rtfeldman$elm_css$Css$property, 'padding-bottom', '3rem')
		]));
...
var $author$project$Pages$Home_$SubmittedForm = {$: 1};
var $author$project$Pages$Home_$TypedInSearch = function (a) {
	return {$: 0, a: a};
};
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$border_indigo_500 = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, '--tw-border-opacity', '1'),
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$inset_y_0 = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$left_0 = A2($rtfeldman$elm_css$Css$property, 'left', '0px');
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pl_12 = A2($rtfeldman$elm_css$Css$property, 'padding-left', '3rem');
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pl_3 = A2($rtfeldman$elm_css$Css$property, 'padding-left', '0.75rem');
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pointer_events_none = A2($rtfeldman$elm_css$Css$property, 'pointer-events', 'none');
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$ring_indigo_500 = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, '--tw-ring-opacity', '1'),
			A2($rtfeldman$elm_css$Css$property, '--tw-ring-color', 'rgba(99, 102, 241, var(--tw-ring-opacity))')
		]));
...
var $author$project$Pages$Home_$viewInput = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$form,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Events$onSubmit($author$project$Pages$Home_$SubmittedForm)
			]),
		_List_fromArray(
			[
				A2(
					...
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$mt_1, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$relative, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$rounded_md, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$shadow_sm]))
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$css(
										_List_fromArray(
											[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$absolute, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$inset_y_0, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$left_0, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pl_3, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$flex, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$items_center, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pointer_events_none]))
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$h_6, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$w_6])),
											...
											[
												...
												_List_fromArray(
													[
														...
														$rtfeldman$elm_css$Svg$Styled$Attributes$d('M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z')
													]),
												_List_Nil)
											]))
									])),
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$value(model.aC),
										$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Pages$Home_$TypedInSearch),
										$rtfeldman$elm_css$Html$Styled$Attributes$css(
										_List_fromArray(
											[
												...
												$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pl_12,
												...
												_List_fromArray(
													[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$ring_indigo_500, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$border_indigo_500])),
												$matheus23$elm_default_tailwind_modules$Tailwind$Breakpoints$sm(_List_Nil)
											])),
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$flex_shrink_0 = A2($rtfeldman$elm_css$Css$property, 'flex-shrink', '0');
...
var $author$project$Pages$Home_$viewImg = function (url) {
	return A2(
...
var $author$project$Pages$Home_$viewItem = function (item) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$bg_white, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$p_4, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$mb_4, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$rounded, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$shadow, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$flex]))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$w_32, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$mr_4, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$flex_shrink_0]))
					]),
				_List_fromArray(
					[
						$author$project$Pages$Home_$viewImg(item.bC)
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$href(item.s)
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text(item.bg)
									]))
							]))
					]))
			]));
};
var $author$project$Pages$Home_$viewItems = function (b) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$m_auto, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$w_full, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$max_w_3xl]))
			]),
		A2($elm$core$List$map, $author$project$Pages$Home_$viewItem, b));
};
				...
				A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$max_w_3xl, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$m_auto, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$py_12]))
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$text_2xl, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$mb_4]))
								]),
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('Search Amazon')
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pb_8]))
								]),
							_List_fromArray(
								[
									$author$project$Pages$Home_$viewInput(model)
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_Nil,
							_List_fromArray(
								[
									$author$project$Pages$Home_$viewItems(model.aW)
								]))
						])))
			]),
		bg: 'Search Amazon'
...
var $author$project$Pages$Home_$page = F2(
	function (shared, req) {
		return $author$project$Page$advanced(
			{a4: $author$project$Pages$Home_$init, be: $author$project$Pages$Home_$subscriptions, b2: $author$project$Pages$Home_$update, a0: $author$project$Pages$Home_$view});
	});
...
var $author$project$Gen$Pages$pages = {
	aw: A3($author$project$Gen$Pages$bundle, $author$project$Pages$Home_$page, $author$project$Gen$Model$Home_, $elm$core$Basics$identity),
	aQ: A2($author$project$Gen$Pages$static, $author$project$Pages$NotFound$view, $author$project$Gen$Model$NotFound)
};
var $author$project$Gen$Pages$init = function (route) {
	if (!route) {
		return $author$project$Gen$Pages$pages.aw.a4(0);
	} else {
		return $author$project$Gen$Pages$pages.aQ.a4(0);
	}
};
...
var $author$project$Gen$Pages$subscriptions = function (model_) {
	switch (model_.$) {
		...
		case 1:
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.aw.be, params, model);
		default:
			var params = model_.a;
			return A2($author$project$Gen$Pages$pages.aQ.be, params, 0);
	}
};
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A4($author$project$Gen$Pages$subscriptions, model.cA, model.A, model.s, model.y)),
				A2(
				$elm$core$Platform$Sub$map,
				$author$project$Main$Shared,
				A2(
					$author$project$Shared$subscriptions,
					A3($author$project$Request$create, 0, model.s, model.y),
					model.A))
			]));
};
...
var $author$project$Gen$Pages$update = F2(
	function (msg_, model_) {
		...
		if (_v0.b.$ === 1) {
			...
			var params = _v1.a;
			var model = _v1.b;
			return A3($author$project$Gen$Pages$pages.aw.b2, params, msg, model);
		} else {
			return F3(
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 0:
				var url = msg.a;
				if (!_Utils_eq(url.bJ, model.s.bJ)) {
					var _v1 = A4(
						$author$project$Gen$Pages$init,
						$author$project$Gen$Route$fromUrl(url),
						model.A,
			...
			case 2:
				...
				var _v3 = A4(
					$author$project$Gen$Pages$init,
					$author$project$Gen$Route$fromUrl(model.s),
					shared,
					model.s,
					model.y);
				var page = _v3.a;
			...
			default:
				var pageMsg = msg.a;
				var _v4 = A5($author$project$Gen$Pages$update, pageMsg, model.cA, model.A, model.s, model.y);
				var page = _v4.a;
				var effect = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Gen$Pages$view = function (model_) {
	switch (model_.$) {
		...
		case 1:
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.aw.a0, params, model);
		default:
			var params = model_.a;
			return A2($author$project$Gen$Pages$pages.aQ.a0, params, 0);
	}
};
var $author$project$Main$view = function (model) {
	return $author$project$View$toBrowserDocument(
		A2(
			...
			$author$project$Main$Page,
			A4($author$project$Gen$Pages$view, model.cA, model.A, model.s, model.y)));
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{a4: $author$project$Main$init, cx: $author$project$Main$ChangedUrl, cy: $author$project$Main$ClickedLink, be: $author$project$Main$subscriptions, b2: $author$project$Main$update, a0: $author$project$Main$view});
