			...
			case 'SubmittedForm':
				return _Utils_Tuple2(
					...
					$author$project$Effect$fromCmd(
						$author$project$Pages$Home_$getSearchResult(model.search)));
			default:
				var results = msg.a;
				if (results.$ === 'Ok') {
					var items = results.a;
...
var $author$project$Pages$Home_$SubmittedForm = {$: 'SubmittedForm'};
var $author$project$Pages$Home_$TypedInSearch = function (a) {
	return {$: 'TypedInSearch', a: a};
};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$value(model.search),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Pages$Home_$viewImg(item.imageUrl)
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$href(item.url)
									]),
								_List_fromArray(
									[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Pages$Home_$viewItems(model.results)
										]))
								]))
						])))
			]),
...
var $author$project$Pages$Home_$page = F2(
	function (shared, req) {
		return $author$project$Page$advanced(
			{init: $author$project$Pages$Home_$init, subscriptions: $author$project$Pages$Home_$subscriptions, update: $author$project$Pages$Home_$update, view: $author$project$Pages$Home_$view});
	});
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Gen.Pages.Msg":{"args":[],"type":"Gen.Msg.Msg"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Pages.Home_.Item":{"args":[],"type":"{ title : String.String, url : String.String, imageUrl : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"ChangedUrl":["Url.Url"],"ClickedLink":["Browser.UrlRequest"],"Shared":["Shared.Msg"],"Page":["Gen.Pages.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Gen.Msg.Msg":{"args":[],"tags":{"Home_":["Pages.Home_.Msg"]}},"Shared.Msg":{"args":[],"tags":{"NoOp":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Pages.Home_.Msg":{"args":[],"tags":{"TypedInSearch":["String.String"],"SubmittedForm":[],"GotSearchResults":["Result.Result Http.Error (List.List Pages.Home_.Item)"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}}}})}});}(this));