...
var $author$project$Pages$Home_$Book = F3(
	function (title, author, url) {
		return {author: author, title: title, url: url};
	});
var $author$project$Pages$Home_$books = _List_fromArray(
	[
		A3($author$project$Pages$Home_$Book, 'Parenting', 'Paul Tripp', 'parenting.webp'),
		A3($author$project$Pages$Home_$Book, 'Finding the Right Hills to Die On: The Case for Theological Triage', 'Gavin Ortlund', 'finding.webp'),
		A3($author$project$Pages$Home_$Book, 'Daring Greatly', 'Brene Brown', 'daring.webp'),
		A3($author$project$Pages$Home_$Book, 'On Birth', 'Tim Keller', 'onbirth.jpeg'),
		A3($author$project$Pages$Home_$Book, 'On Marriage ', 'Tim Keller', 'onmarriage.jpeg'),
		A3($author$project$Pages$Home_$Book, 'On Death ', 'Tim Keller', 'ondeath.jpeg'),
		A3($author$project$Pages$Home_$Book, 'The One Thing ', 'Gary Keller', 'onething.jpg'),
		A3($author$project$Pages$Home_$Book, 'Future Men: Raising Boys to Fight Giants ', 'Douglas Wilson', 'futuremen.webp'),
		A3($author$project$Pages$Home_$Book, 'The Four Seasons of Marriage ', 'Douglas Wilson', 'fourseasons.webp'),
		A3($author$project$Pages$Home_$Book, 'Standing in the Fire ', 'Tom Doyle', 'standing.webp'),
		A3($author$project$Pages$Home_$Book, 'Be a Circle Maker', 'Mark Batterson', 'circle.webp'),
		A3($author$project$Pages$Home_$Book, 'Atomic Habits', 'James Clear', 'atomic.webp')
	]);
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$max_w_xl = A2($rtfeldman$elm_css$Css$property, 'max-width', '36rem');
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$uppercase = A2($rtfeldman$elm_css$Css$property, 'text-transform', 'uppercase');
	...
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$bg_white, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$p_4, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$rounded, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$shadow, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$flex]))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$author$project$Pages$Home_$viewImg(book.url)
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$font_bold, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$text_xl]))
							]),
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text(book.title)
							])),
						A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$text_gray_500, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$uppercase]))
							]),
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text(book.author)
							]))
					]))
			]));
};
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$w_full = A2($rtfeldman$elm_css$Css$property, 'width', '100%');
var $author$project$Pages$Home_$viewBooks = function (b) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$m_auto, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$w_full, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$max_w_xl]))
			]),
		A2($elm$core$List$map, $author$project$Pages$Home_$viewBook, b));
};
	...
	return {
		body: _List_fromArray(
			[
				...
				$author$project$Pages$Home_$viewBooks(
					$elm$core$List$reverse($author$project$Pages$Home_$books)))
			]),
		title: 'hey'
	};
};
